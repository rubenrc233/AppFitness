-- Limpiar y repoblar alimentos

-- Primero eliminar todos los alimentos no personalizados
DELETE FROM food_library WHERE is_custom = FALSE;

-- Resetear el auto_increment (opcional)
ALTER TABLE food_library AUTO_INCREMENT = 1;
